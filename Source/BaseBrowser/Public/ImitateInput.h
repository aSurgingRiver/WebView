...
enum class WebView_Penetrate_Mode: uint8
{
	WebView_Penetrate_Mode_Scenes = 1 UMETA(DisplayName = "Scenes"),
	WebView_Penetrate_Mode_Blend = 0 UMETA(DisplayName = "Blend"),
	WebView_Penetrate_Mode_Both = 2 UMETA(DisplayName = "Both"),
};

UENUM(BlueprintType, Category = "Web View")
enum class WebView_RestFul_Mode : uint8
{
	WebView_RestFul_Mode_Get = 0 UMETA(DisplayName = "GET"),
	WebView_RestFul_Mode_Post = 1  UMETA(DisplayName = "POST"),
	WebView_RestFul_Mode_Put = 2 UMETA(DisplayName = "PUT"),
	WebView_RestFul_Mode_Delete = 3 UMETA(DisplayName = "DELETE"),
};
