...
namespace webview {
	...
	DECLARE_DELEGATE_OneParam(FOnWebState, EWebView_DocumentState );
	DECLARE_DELEGATE_OneParam(FOnTitleChanged, FString );
	DECLARE_DELEGATE_OneParam(FOnUrlChanged, const FString& );
	DECLARE_DELEGATE_RetVal_TwoParams(bool, FOnChkTrans, const FGeometry&, const FPointerEvent& );
	...
	DECLARE_DELEGATE_FourParams(FOnEditEvent, int,int,int,int);
