...
#include "android_export_macro.h"
namespace webview {
	class CAndroidWebImp;
}

class ANDROIDBROWSER_LIB SAndroidWeb
	: public SBaseBrowser
{
public:
	BASEBROWSER_PARAMS(SAndroidWeb)
...
private:
	TSharedPtr<webview::CAndroidWebImp> imp;
